...
class PayrollProjectionLine(models.Model):
        ...
        if view_type == 'tree':
            ...
            for field in fields:
                ...
                for node in doc.xpath(value):
                    mod = '{"readonly": ["|",["exception_id","not in",[%d,%d,%d,%d,%d,%d]],["state","=","closed"]]}'
                    mod = mod % (ajustes_id.id, ajust_year_id.id, rem_id.id, a_tot_pry_id.id, a_dev_imp_id.id, ret_otra_emp_id.id)
    ...
    def calc_per_year_total_january(self):
        if self.exception_id.name == 'Ajuste en Años' and self.january_amount:
    ...
    def calc_per_year_total_february(self):
        if self.exception_id.name == 'Ajuste en Años' and self.february_amount:
            self.march_amount = self.february_amount
            self.april_amount = self.march_amount
            self.may_amount = self.april_amount
            self.june_amount = self.may_amount
    ...
    def calc_per_year_total_march(self):
        if self.exception_id.name == 'Ajuste en Años' and self.march_amount:
            self.april_amount = self.march_amount
            self.may_amount = self.april_amount
            self.june_amount = self.may_amount
            self.july_amount = self.june_amount
    ...
    def calc_per_year_total_april(self):
        if self.exception_id.name == 'Ajuste en Años' and self.april_amount:
            self.may_amount = self.april_amount
            self.june_amount = self.may_amount
            self.july_amount = self.june_amount
            self.august_amount = self.july_amount
    ...
    def calc_per_year_total_may(self):
        if self.exception_id.name == 'Ajuste en Años' and self.may_amount:
            self.june_amount = self.may_amount
            self.july_amount = self.june_amount
            self.august_amount = self.july_amount
            self.september_amount = self.august_amount
    ...
    def calc_per_year_total_june(self):
        if self.exception_id.name == 'Ajuste en Años' and self.june_amount:
            self.july_amount = self.june_amount
            self.august_amount = self.july_amount
            self.september_amount = self.august_amount
            self.october_amount = self.september_amount
    ...
    def calc_per_year_total_july(self):
        if self.exception_id.name == 'Ajuste en Años' and self.july_amount:
            self.august_amount = self.july_amount
            self.september_amount = self.august_amount
            self.october_amount = self.september_amount
            self.november_amount = self.october_amount
    ...
    def calc_per_year_total_august(self):
        if self.exception_id.name == 'Ajuste en Años' and self.august_amount:
            self.september_amount = self.august_amount
            self.october_amount = self.september_amount
            self.november_amount = self.october_amount
            self.december_amount = self.november_amount
    ...
    def calc_per_year_total_september(self):
        if self.exception_id.name == 'Ajuste en Años' and self.september_amount:
            self.october_amount = self.september_amount
            self.november_amount = self.october_amount
            self.december_amount = self.november_amount
    ...
    def calc_per_year_total_october(self):
        if self.exception_id.name == 'Ajuste en Años' and self.october_amount:
            self.november_amount = self.october_amount
            self.december_amount = self.november_amount

    @api.onchange('november_amount')
    def calc_per_year_total_november(self):
        if self.exception_id.name == 'Ajuste en Años' and self.november_amount:
            self.december_amount = self.november_amount
