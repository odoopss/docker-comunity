...
class PayrollProjectionWizard(models.TransientModel):
    ...
    def get_amount_total_anual_proyectado(self, projection_id, periods):
        ...
        for period in periods:
            ...
            if total == 0:
                total += self.get_calc_per_month_project_line('rent_5ta.payroll_projection_exception_05', projection_id, month)
                total += self.get_calc_per_month_project_line('rent_5ta.payroll_projection_exception_06', projection_id, month)
                total += self.get_calc_per_month_project_line('rent_5ta.payroll_projection_exception_07', projection_id, month)
                total += self.get_calc_per_month_project_line('rent_5ta.payroll_projection_exception_10', projection_id, month)
                total += self.get_calc_per_month_project_line('rent_5ta.payroll_projection_exception_11', projection_id, month)
                total += self.get_calc_per_month_project_line('rent_5ta.payroll_projection_exception_year', projection_id, month)
